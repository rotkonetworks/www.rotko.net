   ...
   <div class="bg-gray-900 border-2 border-gray-700 rounded-lg p-4">
     ...
     <div class="relative bg-gray-800 rounded p-2 overflow-hidden" style={{ height: `${rack_u * unit_height + 20}px` }}>
       ...
       <For each={devices}>
         {(device) => (
           <div
             class="absolute left-2 right-2 flex items-center justify-center text-xs font-mono font-bold rounded group"
             style={{
           ...
           >
             ...
             <Show when={device.details}>
               <div class="absolute hidden group-hover:block bg-black text-white p-2 rounded text-xs whitespace-nowrap z-10 bottom-full mb-1">
                 {device.details}
               </div>
             </Show>
           </div>
