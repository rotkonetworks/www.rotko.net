...
export const rackConfiguration: RackConfig = {
 ...
 devices: [
   ...
   { name: "bkk12", bottom_u: 13, height_u: 1, color: "#66FFB3", type: "Validator", details: "Ryzen 7950X Validator Node" },
   { name: "bkk13", bottom_u: 14, height_u: 1, color: "#66FFB3", type: "Validator", details: "Ryzen 5950X Validator Node" },
   { name: "bkk03", bottom_u: 20, height_u: 1, color: "#66FFB3", type: "Validator", details: "Ryzen 7950X3D Validator Node" },
   { name: "bkk04", bottom_u: 21, height_u: 1, color: "#66FFB3", type: "Validator", details: "Ryzen 9950X Validator Node" },
